...
- **Custom paste keys** — choose your own memorable key (4-40 chars, optional; spaces auto-converted to `-`)
...
- **Load paste by ID** — paste ID + Go in the top navbar on editor and viewer pages (`/` focuses the input)
